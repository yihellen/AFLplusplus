...
static void usage(u8* argv0) {
  ...
  SAYF("\n%s [ options ] -- /path/to/fuzzed_app [ ... ]\n\n"
       ...
       "TCP/IP network fuzzing: (see docs/READNE.network_fuzzing)\n"
       "  -N type://path:port  - fuzzed program reads from a network port.\n"
       "                  type={udp|tcp} path={::1|127.0.0.1|localhost}\n"
...
int main(int argc, char** argv) {
  ...
  while ((opt = getopt(argc, argv, "+i:o:f:m:t:T:dnCB:S:M:x:Qe:p:s:V:E:L:N:D:K")) > 0)
